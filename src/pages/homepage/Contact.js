            ...
            <div className="custom-container">
                ...
                <div className="flex flex-col lg:flex-row">
                    <div className=" basis-1/3 flex items-center">
                        <div className="w-full bg-gradient-to-r from-[#6D83F2] to-primary text-white py-20 rounded-t-lg lg:rounded-l-lg">
                            <FaHandshake className='text-[150px] mx-auto' />
                            <h4 className='text-xl text-center font-bold mb-5'>Thank You</h4>
                            <p className='text-center mb-5'>Love to build long-term relationship</p>
                            <p className='text-center'>murshedbinamir@gmail.com</p>
                            <p className='text-center'>(+880) 1882820824</p>
                        </div>
                    </div>
