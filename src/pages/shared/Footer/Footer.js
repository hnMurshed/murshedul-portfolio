    ...
    return (
        <footer className='bg-primary text-center py-16'>
            ...
            <div className="flex items-center justify-center gap-5 text-white text-2xl">
                <a href='https://github.com/hnMurshed' target='_blank' rel='noreferrer' className='border-2 border-slate-400 hover:bg-white hover:text-primary duration-300 p-3 rounded-full'><FaTwitter /></a>
                ...
                <a href='https://github.com/hnMurshed' target='_blank' rel='noreferrer' className='border-2 border-slate-400 hover:bg-white hover:text-primary duration-300 p-3 rounded-full'><FaFacebookF /></a>
                <a href='https://github.com/hnMurshed' target='_blank' rel='noreferrer' className='border-2 border-slate-400 hover:bg-white hover:text-primary duration-300 p-3 rounded-full'><HiOutlineMail /></a>
            </div>
